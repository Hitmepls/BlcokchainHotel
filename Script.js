...
async function loadContract() {
  return await new window.web3.eth.Contract(
    abi,
    "0xAff928F91edF9D3649C4E44e92FC4D0F95cC9df4"
  );
}
...
$("#button1").click(function () {
  window.contract.methods.reserveRoom(t.getHours()+":"+t.getMinutes(),$("#button1").val())
...
$("#button2").click(function () {
  window.contract.methods.reserveRoom(t.getHours()+":"+t.getMinutes(),$("#button2").val())
...
$("#button3").click(function () {
  window.contract.methods.reserveRoom(t.getHours()+":"+t.getMinutes(),$("#button3").val())
...
$("#button5").click(function () {
  window.contract.methods.reserveRoom(t.getHours()+":"+t.getMinutes(),$("#button5").val())
...
$("#button6").click(function () {
  window.contract.methods.reserveRoom(t.getHours()+":"+t.getMinutes(),$("#button6").val())
  .send({from: currentAccount,value:50000000000000},function (error, result) {
    if (!error) {
      $("#result").html(result.toString());
    } else console.error(error);
